# Evolution Simulation - Version a011
import pygame
import random
...
# Optimization: Create a Quadtree for collision management
from quadtree import QuadTree
quad_tree = QuadTree(0, pygame.Rect(0, 0, WIDTH, HEIGHT))
...
while running:
    ...
    # Optimization: Clear and update the Quadtree
    quad_tree.clear()
    for organism in organisms:
        quad_tree.insert(organism)
    ...
    for organism in organisms:
        potential_collisions = quad_tree.query(organism.rect)
        for other in potential_collisions:
            if organism != other and pygame.sprite.collide_rect(organism, other):
                reproduce(organism)
